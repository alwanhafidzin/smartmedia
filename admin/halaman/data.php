<?php
    ...
    $data_buku = mysqli_query($konek, "SELECT buku.*, kat.* FROM data_buku buku INNER JOIN kategori_buku kat ON buku.id_kategori=kat.id_kategori ORDER BY buku.id_buku DESC");
    $kategori_buku = mysqli_query($konek, "SELECT * FROM kategori_buku");
?>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    if(strlen(trim($row['deskripsi']))>30) echo " [...]"; 
                                                ?>
                                            </td>
                                            <td><?php echo $row['stok']; ?></td>
                                            <td>
                                                <a data-fancybox="gallery" href="buku/<?php echo $row['cover']; ?>">
                                                    <img src="buku/<?php echo $row['cover']; ?>" class="img-thumbnail img-responsive" alt="img" style="width:50px;">
                                                </a>
                                            </td>
                                            <td>
                                                <form action="lib/proses.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $row['id_buku']; ?>">
                                                <?php if($row['best_sell']==1) {?>
                                                ...
                                                <a href="" data-toggle="modal" data-target=".edit" data-id='<?php echo $row['id_buku']; ?>' data-judul='<?php echo $row['judul']; ?>' 
                                                data-pengarang='<?php echo $row['pengarang']; ?>' data-penerbit='<?php echo $row['penerbit']; ?>' data-harga='<?php echo $row['harga']; ?>'
                                                data-halaman='<?php echo $row['halaman']; ?>' data-kategori='<?php echo $row['id_kategori']; ?>' data-deskripsi='<?php echo $row['deskripsi']; ?>' 
                                                ...
                                                <a href="" data-toggle="modal" data-target=".hapus" data-id='<?php echo $row['id_buku']; ?>' data-judul='<?php echo $row['judul']; ?>' 
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-control">
                                <?php while($row=mysqli_fetch_assoc($kategori_buku)){ ?>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-control">
                                <?php 
                                    $kat=mysqli_query($konek, "SELECT * FROM kategori_buku");
