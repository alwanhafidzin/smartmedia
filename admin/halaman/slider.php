<?php 
    ...
    $slider=mysqli_query($konek, "SELECT * FROM slider ORDER BY id_slide ASC");
?>
                                   ...
                                   <table id="keywords" cellspacing="0" cellpadding="0" class="table table-condensed table-hover table-responsive table-striped table-bordered">
                                        ...
                                        ?>
                                          <tr>
                                             ...
                                             <td>
                                                 <a data-fancybox="gallery" href="slider/<?php echo $row['gambar']; ?>">
                                                    <img src="slider/<?php echo $row['gambar']; ?>" class="img-thumbnail img-responsive" alt="img" style="width:100px;">
                                                </a>
                                            </td>
                                             <td><?php echo $row['urutan']; ?></td>
                                             <td>
                                                 <a href="#" data-toggle="modal" data-target=".edit" data-id='<?php echo $row['id_slide']; ?>' data-judul='<?php echo $row['judul']; ?>'
                                                ...
                                                <a href="#" data-toggle="modal" data-target=".hapus" data-id='<?php echo $row['id_slide']; ?>' data-judul='<?php echo $row['judul']; ?>'
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            <label for="gambar">Gambar Slider(max 2 mb)</label>
