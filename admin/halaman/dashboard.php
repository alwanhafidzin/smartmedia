<?php
    ...
    $komentar=mysqli_query($konek, "SELECT id_komentar FROM komentar");
    $slide=mysqli_query($konek, "SELECT id_slide FROM slider");
    $stok_buku=mysqli_query($konek, "SELECT SUM(stok) FROM data_buku");
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div role="alert" class="alert color green-bg fade in alert-dismissible">
                                ...
                                <strong>Berhasil login!</strong> selamat, Anda berhasil login sebagai admin Smartmedia.
                    </div>
                    <?php } } ?>
                </div>
